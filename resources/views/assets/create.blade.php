          ...
          <table style="width: 80%" border=0>
              <tr>
                  ...
                  <td style="width:300px;">
                    <input type="text" name="nama_asset" id="nama_asset" class="form-control @error('nama_asset') is-invalid @enderror" placeholder="Nama Asset">
                  ...
                  <td style="width:10px;">:</td>
                  <td style="width:300px;">
                    <input type="text" name="lokasi" id="lokasi" class="form-control @error('lokasi') is-invalid @enderror" placeholder="Lokasi Aset">
              ...
              <tr>
                  ...
                  <td>:</td>
                  <td>
                    <input type="text" name="jml_blok" id="jml_blok" class="form-control @error('jml_blok') is-invalid @enderror" placeholder="Jumlah Blok">
                  ...
                  <td>:</td>
                  <td>
                    <input type="text" name="sisa_blok" id="sisa_blok" class="form-control @error('sisa_blok') is-invalid @enderror" placeholder="Sisa Blok">
              ...
              <tr>
                ...
                <td>:</td>
                <td colspan="5">
                    <img src="/images/assets/default.png" style="height:400px;" class="mt-2">
